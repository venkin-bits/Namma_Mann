...
![WhatsApp Image 2026-02-04 at 22 33 01](https://github.com/user-attachments/assets/a0edb4a8-cd11-4ba1-8714-349e5699fe28)

![WhatsApp Image 2026-02-04 at 22 28 39](https://github.com/user-attachments/assets/54b3ae3e-c2bb-42ce-952d-adedef8932fb)




ML is trained under the following data sets to identify pests and damaged crops

Since 3 data sets required a lot of training load, it takes a total of 7 hours to train a single epoch out of 50 epochs (number of iterations and single iterations contain more than 3000 images)
...
link: https://agritech.tnau.ac.in/itk/IndigenousTechKnowledge_Crop_Rice.html, following this, at the bottomof the  preparation page link is provided 

TNAU / Govt of TN
link: http://www.agritech.tnau.ac.in/org_farm/orgfarm_pestanddisease.html

**Our primary goal is to empower local farmers through cost-free, accessible technology. While WhatsApp was identified as the ideal, user-friendly platform, the costs associated with the Business API prompted us to develop a simulated, similar environment to deliver the same functionality without financial barriers."**
